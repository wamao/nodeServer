...
// 提交订单
let  addOrder=(value)=>{
//let  _sql= 'insert into orderlist (userId,orderId,goodsId,addressId,goodsNumber,orderType,goodsSize,remark) values ("sdd5s2ds455a8sd5ad85885da5",2,2,4,1,0,2,5);' 
    
  let _sql=`insert into orderlist (userId,orderId,goodsId,addressId,goodsNumber,orderType,goodsSize,remark) values ${value};`
    return query(_sql,[]);
}
