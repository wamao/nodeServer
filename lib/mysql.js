...
// 创建商品列表
  let goods=
    `create table if not exists goods(
     ...
     TopCategoryId  VARCHAR(100) NOT NULL,
     SecondaryCategoryId  VARCHAR(100) NOT NULL,
     ThirdCategoryId  VARCHAR(100) NOT NULL,
     goodsSize   VARCHAR(100) NOT NULL,
     goodsStyle VARCHAR(100) NOT NULL,
     PRIMARY KEY ( id )
    )ENGINE=MyISAM DEFAULT CHARSET=utf8;`
...
// 创建购物车表
  let cartlist =
    `create table if not exists cartlist(
     ...
     goodsName   VARCHAR(100) NOT NULL,
     goodsPrice   VARCHAR(100) NOT NULL,
     goodsImgUrl     VARCHAR(100) NOT NULL,
     goodsId    VARCHAR(100) NOT NULL,
